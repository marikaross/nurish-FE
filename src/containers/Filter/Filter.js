...
export class Filter extends Component {
  ...
  handleSubmit = async event => {
    ...
    let allergenQuery = this.state.allergens.length
      ? this.state.allergens.join()
      : "";
    let specialtyQuery = this.state.specialty.length
      ? this.state.specialty.join()
      : "";
    ...
    return (
      <div className="form-container filter-container">
        ...
        <form className="filter-form" onSubmit={this.handleSubmit}>
          ...
          />
          <Dropdown
            onChange={this.handleMCT}
            placeholder="mct split"
            fluid
            selection
            options={mctSplit}
          />
